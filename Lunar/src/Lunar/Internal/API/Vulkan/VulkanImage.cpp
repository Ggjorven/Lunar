...
namespace Lunar::Internal
{
	...
	// Init & Destroy
	////////////////////////////////////////////////////////////////////////////////////
	void VulkanImage::Init(RendererID renderer, const VulkanImageSpecification& specs, const VulkanSamplerSpecification& samplerSpecs)
	{
		m_Renderer = renderer;
	...
	void VulkanImage::Init(RendererID renderer, const VulkanImageSpecification& specs, const VkImage image, const VkImageView imageView) // Note: This exists for swapchain images
	{
		m_Renderer = renderer;
		m_ImageSpecification = specs;
