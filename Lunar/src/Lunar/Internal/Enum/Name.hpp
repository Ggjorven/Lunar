...
namespace Lunar::Internal::Enum
{
    ...
    {
    public:
        constexpr static const std::string_view ClassToken = "Lunar::Internal::Enum::ConstexprName<";
    ...
    constexpr auto ValuesImpl(std::index_sequence<I...>)
    {
        ...
        static_assert(validCount > 0, "No support for empty enums."); // TODO: Fix GCC and CLANG
