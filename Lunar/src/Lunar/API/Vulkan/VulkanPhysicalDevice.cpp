...
namespace Lunar
{
    ...
    {
        // Note: Since a PhysicalDevice is not something we created there is nothing to destroy.
    }
    ...
    VkFormat VulkanPhysicalDevice::FindSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features)
    {
        for (VkFormat format : candidates) 
        {
            ...
            vkGetPhysicalDeviceFormatProperties(VulkanContext::GetVulkanPhysicalDevice()->GetVkPhysicalDevice(), format, &props);
	...
	// Static methods
    ////////////////////////////////////////////////////////////////////////////////////
	Arc<VulkanPhysicalDevice> VulkanPhysicalDevice::Select(const VkSurfaceKHR surface)
	{
		return Arc<VulkanPhysicalDevice>::Create(surface);
	}
