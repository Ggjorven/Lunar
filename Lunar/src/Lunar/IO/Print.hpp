...
namespace Lunar
{
	...
	namespace Log
	{
        ...
        #define LU_LOG_TRACE(...)       ::Lunar::Log::PrintLvl<::Lunar::Log::Level::Trace>(__VA_ARGS__)
        #define LU_LOG_INFO(...)        ::Lunar::Log::PrintLvl<::Lunar::Log::Level::Info>(__VA_ARGS__)
        #define LU_LOG_WARN(...)        ::Lunar::Log::PrintLvl<::Lunar::Log::Level::Warn>(__VA_ARGS__)
        #define LU_LOG_ERROR(...)       ::Lunar::Log::PrintLvl<::Lunar::Log::Level::Error>(__VA_ARGS__)
        #define LU_LOG_FATAL(...)       ::Lunar::Log::PrintLvl<::Lunar::Log::Level::Fatal>(__VA_ARGS__)
